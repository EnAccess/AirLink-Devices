...
{
    LOG_INF("[Keycode] PAYG unlocking this device");
...
{
    LOG_INF("[Keycode] Adding %d credit to this device", credit);
...
{
    LOG_INF("[Keycode] Setting remaining credit=%d seconds", credit);
