...
// XXX do we need to make any modifications to support a "composite" device model?
oc_device_info_t *
                       ...
                       oc_core_add_device_cb_t add_device_cb, void *data)
{
  ...
  // no discovery/introspection features suppported for now
  ...
  /* TODO build this out when we're interfacing with a real transport
